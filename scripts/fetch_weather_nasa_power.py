...
DEFAULT_OUTPUT = ROOT / "data/processed/nasa_power_sample_daily.csv"
DEFAULT_PROVENANCE = ROOT / "data/processed/nasa_power_sample_provenance.json"
DEFAULT_LOG = ROOT / "data/processed/nasa_power_sample_log.md"
